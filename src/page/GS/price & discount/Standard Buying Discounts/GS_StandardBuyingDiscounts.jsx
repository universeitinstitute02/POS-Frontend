...
const GS_StandardBuyingDiscounts = () => {
    const location = useLocation();
    useEffect(() => {
        document.title = "Standard Buying Discounts";
    }, [location]);
                ...
                <div className="flex  justify-center">
                    <div className="font-semibold border border-[#C0C0C0] pb-2 max-w-2xl">
                        ...
                        <div className="">
                            ...
                            <div className="flex gap-1 space-y-2">
                                <div className="w-1/3 pt-2">
                                    <p className='float-end text-xs text-labelBlue'>Price Category</p>
                                </div>
                                <div className="w-2/3">
                                    <div className="flex">
                                        <select name="unit" id="unit" className='border border-black rounded text-xs' required>
...
export default GS_StandardBuyingDiscounts;