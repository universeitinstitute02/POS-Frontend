...
const GS_ContractBuyingDiscounts = () => {
    const location = useLocation();
    useEffect(() => {
        document.title = "Contract Buying Discounts";
    }, [location]);
            ...
            <div className="container mx-auto">
                <div className="pt-5 text-blue-500 font-semibold pb-2">
                    <p className='text-center'>
                        Supplier Contract Discounts
                        Click here for Standard Prices Maintenance
                    </p>
                </div>
...
export default GS_ContractBuyingDiscounts;