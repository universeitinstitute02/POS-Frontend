...
const GS_SpecialBuyingPrices = () => {
    const location = useLocation();
    useEffect(() => {
        document.title = "Special Buying Prices by Price Code Maintenance";
    }, [location]);
        ...
        <>
            <div className="container mx-auto">
                <div className="pt-5 text-blue-500 font-semibold pb-2">
                    ...
                    Special Selling Prices by Price Code Maintenance</p>
                </div>
...
export default GS_SpecialBuyingPrices;