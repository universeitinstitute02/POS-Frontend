...
const GS_ContractSellingDiscounts = () => {
    const location = useLocation();
    useEffect(() => {
        document.title = "Customer Contract Discounts";
    }, [location]);
        ...
        <>
            <div className="container mx-auto">
                <div className="pt-5 text-blue-500 font-semibold pb-2">
                    ...
                    Customer Contract Discounts Click here for Standard Prices Maintenance
                    </p>
                </div>
...
export default GS_ContractSellingDiscounts;