...
const GS_StandardBuyingRateTables = () => {
    const location = useLocation();
    useEffect(() => {
        document.title = "Standard Buying Rate Tables";
    }, [location]);
        ...
        <>
            <div className="container mx-auto">
                <div className="pt-5 text-blue-500 font-semibold pb-2">
                    <p className='text-center'>Purchase Rates Maintenance</p>
                </div>
...
export default GS_StandardBuyingRateTables;