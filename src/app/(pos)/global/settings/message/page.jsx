...
const MessageSettingsPage = () => {
    ...
    const messageList = [
        { code: '01', desc: 'Header message', type: 'General' },
        { code: '02', desc: 'Footer message', type: 'General' },
    ];
        ...
        <div className="container mx-auto px-2">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-4">
                <p className='text-center text-xs text-blue-400 font-semibold mb-6 italic'>
                    Configure system-wide messages and alerts.
                </p>
                ...
                {/* FORM FIELDS */}
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-8 text-[11px] font-bold text-blue-600">
                    <div className="flex flex-col gap-1">
                        <label>Code</label>
                        <input type="text" defaultValue="01" className="border border-gray-400 rounded px-2 py-1 text-black font-normal outline-none focus:ring-1 focus:ring-blue-500" />
                    </div>
                    <div className="flex flex-col gap-1 md:col-span-4">
                        <label>Long Description</label>
                        <textarea className="border border-gray-400 rounded px-2 py-1 text-black font-normal outline-none focus:ring-1 focus:ring-blue-500 h-20" defaultValue="Header message"></textarea>
                    </div>
                    <div className="flex flex-col gap-1">
                ...
                <div className="mt-10 border border-gray-200 rounded-lg overflow-hidden">
                    <div className="bg-gray-50 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <span className="text-xs font-bold text-gray-500 uppercase">Message Registry</span>
                    </div>
                        ...
                        <table className="w-full text-xs border-collapse">
                            <thead>
                                <tr className="bg-[#F4F6F8] text-blue-800 border-b border-gray-200">
                                    <th className="p-2 text-left bg-blue-50">Code ⇑</th>
                                    <th className="p-2 text-left">Long Description</th>
                                    <th className="p-2 text-left">Message Type</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {messageList.map((item, i) => (
                                    <tr key={i} className="hover:bg-blue-50 transition-colors">
                                        <td className="p-2 font-bold text-gray-800 bg-gray-50">{item.code}</td>
                                        <td className="p-2 text-gray-600">{item.desc}</td>
                                        <td className="p-2 text-gray-600 font-medium">{item.type}</td>
