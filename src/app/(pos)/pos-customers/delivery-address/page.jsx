    ...
    return (
        <div className="container mx-auto px-2">
            <div className="pt-5 text-blue-600 font-bold pb-4">
                <p className='text-center text-lg'>Customer Delivery Address</p>
            </div>
            ...
            <div className="font-semibold border border-gray-300 bg-white rounded shadow-sm pb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-6 py-2 text-xs">
                    <div className="flex gap-2 items-center">
                        <div className="w-1/3 text-right flex items-center justify-end gap-1 text-[#1B71A2]">
                            <p>Address ID</p><FcSearch />
                        </div>
                        <div className="w-2/3"><input type="text" defaultValue={0} className='w-full px-2 py-1 border border-gray-400 rounded outline-none focus:ring-1 focus:ring-blue-500 focus:bg-focusColor' autoFocus /></div>
                    </div>
                    <div className="flex gap-2 items-center">
                        <div className="w-1/3 text-right text-[#1B71A2] font-semibold"><p>Name *</p></div>
                        <div className="w-2/3"><input type="text" className='w-full px-2 py-1 border border-gray-400 rounded outline-none focus:ring-1 focus:ring-blue-500 focus:bg-focusColor' /></div>
                    </div>
                    <div className="flex gap-2 items-center">
                        <div className="w-1/3 text-right font-semibold"><p className='text-customRed'>*Phone</p></div>
                        <div className="w-2/3"><input type="text" className='w-full px-2 py-1 border border-gray-400 rounded outline-none focus:ring-1 focus:ring-blue-500 focus:bg-focusColor' /></div>
                    </div>
                    <div className="flex gap-2 items-center md:col-span-2">
                        <div className="w-1/6 text-right text-[#1B71A2] font-semibold"><p>Address</p></div>
                        <div className="w-5/6"><input type="text" className='w-full px-2 py-1 border border-gray-400 rounded outline-none focus:ring-1 focus:ring-blue-500 focus:bg-focusColor' /></div>
                    </div>
                    <div className="flex gap-2 items-center">
                        <div className="w-1/3 text-right text-[#1B71A2] font-semibold"><p>City</p></div>
                        <div className="w-2/3"><input type="text" className='w-full px-2 py-1 border border-gray-400 rounded outline-none focus:ring-1 focus:ring-blue-500 focus:bg-focusColor' /></div>
                    </div>
                    <div className="flex gap-2 items-center md:col-span-2">
                        <div className="w-1/6 text-right text-[#1B71A2] font-semibold"><p>Note</p></div>
                        <div className="w-5/6"><input type="text" className='w-full px-2 py-1 border border-gray-400 rounded outline-none focus:ring-1 focus:ring-blue-500 focus:bg-focusColor' /></div>
                    </div>
                </div>
            </div>
