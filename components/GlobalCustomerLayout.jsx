...
const GlobalCustomerLayout = () => {
    ...
    const tabs = [
        { name: 'Customer', href: '/global/customer' },
    ];

    const inactiveTabs = [
        'Delivery Address', 'Milestones', 'Prices', 'Discounts', 
        'Payment Methods', 'Shipping Methods', 'Contacts', 
        'Credit Limit', 'Docs', 'Activities', 'Orders', 'Consignments'
    ];
