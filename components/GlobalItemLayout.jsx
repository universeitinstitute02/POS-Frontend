...
const GlobalItemLayout = () => {
    const pathname = usePathname();

    const tabs = [
        { name: 'Item', href: '/global/item' },
    ];

    const inactiveTabs = ['Prices', 'Kits', 'Cross References', 'Serial Numbers', 'Docs', 'Bar Code'];
...
export default GlobalItemLayout;
